/*
 * @Author: RyanJiang
 * @Date: 2023-05-24 19:42:31
 * @LastEditTime: 2023-05-24 19:42:33
 * @LastEditors: RyanJiang
 * @Description: 
 * @FilePath: /LandCameraDemo/jsts.d.ts
 */
...
declare namespace jsts {
    ...
    namespace algorithm {
        ...
        export class BoundaryNodeRule {
            static Mod2BoundaryNodeRule = Mod2BoundaryNodeRule;
            static EndPointBoundaryNodeRule = EndPointBoundaryNodeRule;
            static MultiValentEndPointBoundaryNodeRule = MultiValentEndPointBoundaryNodeRule;
            static MonoValentEndPointBoundaryNodeRule = MonoValentEndPointBoundaryNodeRule;
            static MOD2_BOUNDARY_RULE = new Mod2BoundaryNodeRule();
            static ENDPOINT_BOUNDARY_RULE = new EndPointBoundaryNodeRule();
            static MULTIVALENT_ENDPOINT_BOUNDARY_RULE = new MultiValentEndPointBoundaryNodeRule();
            static MONOVALENT_ENDPOINT_BOUNDARY_RULE = new MonoValentEndPointBoundaryNodeRule();
            static OGC_SFS_BOUNDARY_RULE = BoundaryNodeRule.MOD2_BOUNDARY_RULE;
        }
    ...
    namespace geom {
        ...
        export class GeometryFactory {
            buildGeometry(geom: Iterable<Geometry>): Geometry;
            createMultiLineString(backgroud: LineString[]): MultiLineString;
            createGeometry(geometry: Polygon | LineString): Geometry;
            createMultiPolygon(arg0: Polygon[]): MultiPolygon;
            ...
            createMultiPointFromCoords(coordinates: Coordinate[]): geom.MultiPoint;
        }
        ...
        namespace util {
            export class LineStringExtracter {
                static getLines(g: Geometry): Iterable<geom.LineString>;
            }
            ...
            export class LinearComponentExtracter {
                static getLines(g: Geometry): ArrayList;
            }
        }
        ...
        export class LineSegment {
             ...
             */
            project(seg: LineSegment): LineSegment;
    ...
    namespace operation {
        ...
        export class BoundaryOp {
            static getBoundary(
                g: geom.Geometry,
                bnRule: algorithm.BoundaryNodeRule
            ): jsts.geom.Geometry;
        }
        namespace linemerge {
            export class LineMerger {
                add(g: geom.Geometry);
                getMergedLineStrings(): java.util.Collection;
            }
        }
        namespace polygonize {
            export class Polygonizer {
                constructor(extractOnlyPolygonal: boolean = true);
                getGeometry(): jsts.geom.Geometry;
                getCutEdges(): ArrayList<jsts.geom.Geometry>;
                getDangles(): HashSet<String, jsts.geom.Geometry>;
                getInvalidRingLines(): ArrayList<jsts.geom.Geometry>;
                add(lines: any) {}
            }
        }
        ...
        namespace buffer {
            ...
            export class BufferOp {
                 ...
                 *
                 */
                static bufferOp(g: Geometry, distance: number, params: BufferParameters): Geometry;
                 ...
                 *
                 */
                static bufferOp(g: Geometry, distance: number, quadrantSegments: number): Geometry;
        ...
        namespace union {
            export class UnaryUnionOp {
                static union(geom: Geometry): Geometry;
            }
        }
        namespace distance {
            export class DistanceOp {
                 ...
                 */
                static nearestPoints(g0: geom.Geometry, g1: geom.Geometry): geom.Coordinate[];
            }
        }
    }
    namespace noding {
        export class SegmentStringUtil {
            static toGeometry(arg0: any, factory: geom.GeometryFactory): geom.Geometry {
                throw new Error('Method not implemented.');
            }
            static extractNodedSegmentStrings(geom: geom.Geometry) {
                throw new Error('Method not implemented.');
            }
            constructor(parameters) {}
        }
        export class MCIndexNoder {
            getNodedSubstrings(): geom.GeometryCollection;
            computeNodes(seg: void) {
                throw new Error('Method not implemented.');
            }
            constructor(parameters) {}
        }
        export class IntersectionAdder {
            constructor(li: jsts.algorithm.LineIntersector);
        }
    }
    namespace dissolve {
        export class LineDissolver {
            static dissolve(g: geom.Geometry): geom.Geometry;
        }
    }
    namespace java {
        namespace util {
    ...
    namespace densify {
        export class Densifier {
            static densify(geom: jsts.geom.Geometry, distanceTolerance: number): jsts.geom.Geometry;
        }
    }
    namespace simplify {
