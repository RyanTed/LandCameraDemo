...
var pack = {
    readToolsEnv: function () {
        let packToolPath = Editor.Project.path + '/packages/texturecompression/toolsEnv.json'
        if(!fs.existsSync(packToolPath)) {
            packToolPath = process.env.HOME + '/.CocosCreator/packages/texturecompression/toolsEnv.json'
        }
        if(fs.existsSync(packToolPath)) {
    ...
    startPack: function () {
        ...
        let resPath = buildPath + "assets/resources"
        this.resPath = resPath;

        //define iOS res path.
        let resPathIOS = buildPath + "packResIOS/resources";
        this.resConfigIOS = resPathIOS + "/pack.config";
        this.resRootPathIOS = buildPath + "packResIOS";

        //define android res path.
        let resPathAndroid = buildPath + "packResAndroid/resources";
        ...
        this.destIOSResPath = buildPath + "pack-temp-ios/resources";
        this.destIOSResRoot = buildPath + "pack-temp-ios";

        this.destAndroidResPath = buildPath + "pack-temp-android/resources";
    ...
    packFiles: function (index) {
        ...
        if (this.srcfiles.length > index) {
            ...
            let key = sfile.replace(Editor.Project.path, '');
